...
public class InsuranceDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Insurance>().OwnsOne(i => i.InsuranceNumber).Property(i => i.Number).HasColumnName("InsuranceNumber");
        modelBuilder.Entity<Insurance>().OwnsOne(i => i.YearlyPremium).Property(i => i.Amount).HasColumnName("YearlyPremium").HasColumnType("decimal(18,4)");
        ...
        modelBuilder.Entity<Insurer>().OwnsOne(i => i.OrganizationNumber).Property(i => i.Number).HasColumnName("OrganizationNumber");
